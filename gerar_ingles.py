...
# -*- coding: utf-8 -*-
"""
Gera a versao em INGLES do MAPA-GR em docs/en/, a partir das paginas em portugues.
...
O service worker e o manifesto PWA continuam sendo os do app (escopo /Mapa-GR/,
que cobre /Mapa-GR/en/). O nome que aparece ao instalar fica em portugues — e a
...
def estrutura(html, pagina):
    ...
    html = html.replace(
        ...
        marca + '\n<!-- en/ e subpasta: sem isto, dados, icones e Chart.js seriam\n'
                '     procurados em /Mapa-GR/en/ e nao existiriam la. -->\n'
                '<base href="../">', 1)
    ...
    html = html.replace("'en/comparador.html?mode=top10", "'en/comparador.html?mode=top10")
...
def main():
    ...
    print("MAPA-GR  PT -> EN" + ("  (conferencia)" if conferir else ""))
